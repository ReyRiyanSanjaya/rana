      ...
      child: MaterialApp(
        ...
        theme: ThemeData(
          ...
          appBarTheme: const AppBarTheme(
            backgroundColor: kBrandColor, // [FIX] Global Red Brand
            foregroundColor: Colors.white,
            iconTheme: IconThemeData(color: Colors.white), // [FIX] Ensure icons are white
            elevation: 0,
            scrolledUnderElevation: 0,
            shape: Border(bottom: BorderSide(color: kBrandColor, width: 1)),
            centerTitle: true,
          ...
          inputDecorationTheme: InputDecorationTheme(
            ...
            enabledBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(20),
              borderSide: BorderSide(color: kBrandColor.withOpacity(0.3), width: 1),
            ),
            focusedBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(20),
              borderSide: const BorderSide(color: kBrandColor, width: 2), // Red Ring
            ),
