      ...
      body: _isLoading 
        ...
        : ListView(
          ...
          Padding(
            ...
            child: Row(
              children: [
                _buildStatCard('Omzet', 'Rp 1.5jt', Colors.blue),
                const SizedBox(width: 16),
                _buildStatCard('Laba Bersih', 'Rp 450rb', Colors.green), // [UPDATED] Net Profit Label
              ],
            ),
          ),
          ...
          const SizedBox(height: 16),
               ...
               const Padding(
                 ...
                 child: Text('Tren Penjualan (7 Hari)', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
               ),
               const SizedBox(height: 16),
               Padding(
                 padding: const EdgeInsets.all(16.0),
