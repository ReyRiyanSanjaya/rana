        ...
        : SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('Rp ${widget.amount}', style: const TextStyle(fontSize: 32, fontWeight: FontWeight.bold, color: Colors.indigo)),
              const SizedBox(height: 32),
              
              const Text('Scan QRIS Platform', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
              ...
              if (_qrisUrl != null)
                Image.network(
                  ...
                  errorBuilder: (ctx, _, __) => const Icon(Icons.broken_image, size: 100),
                ),
                
              const SizedBox(height: 24),
              const Divider(),
              const SizedBox(height: 16),
              const Text('Atau Transfer Bank:', style: TextStyle(fontWeight: FontWeight.bold)),
              const SizedBox(height: 8),
